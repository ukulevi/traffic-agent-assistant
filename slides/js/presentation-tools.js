...
(function () {
    ...
    const chapters = [
        { num: 0, title: 'Trang bìa', color: '#005ce6', slideFile: '00_00_cover.html' },
        { num: 0, title: 'Mục lục', color: '#005ce6', slideFile: '00_01_toc.html' },
        { num: 1, title: 'Giới Thiệu', color: '#005ce6', slideFile: '01_00_chapter.html' },
        { num: 2, title: 'Cơ Sở Lý Thuyết', color: '#ef4444', slideFile: '02_00_chapter.html' },
        { num: 3, title: 'Kiến Trúc Hệ Thống', color: '#10b981', slideFile: '03_00_chapter.html' },
        { num: 4, title: 'Tầng 1: Data Pipeline', color: '#f97316', slideFile: '04_00_chapter.html' },
        { num: 5, title: 'Tầng 2: ML & Surrogate', color: '#3b82f6', slideFile: '05_00_chapter.html' },
        { num: 6, title: 'Tầng 3: Knowledge & RAG', color: '#10b981', slideFile: '06_00_chapter.html' },
        { num: 7, title: 'Tầng 4: Agent & Safety', color: '#8b5cf6', slideFile: '07_00_chapter.html' },
        { num: 8, title: 'Triển Khai', color: '#f59e0b', slideFile: '08_00_chapter.html' },
        { num: 9, title: 'Đánh Giá', color: '#0ea5e9', slideFile: '09_00_chapter.html' },
        { num: 10, title: 'Rủi Ro', color: '#6366f1', slideFile: '10_00_chapter.html' },
    ];
