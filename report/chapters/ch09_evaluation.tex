...
được ghi atomically và chỉ pass khi đủ 13 capability bắt buộc, không giữ video
...
\midrule
\texttt{succeeded} & 3 & approve, reject và refinement hai candidate \\
\rowcolor{rowgray}
\texttt{needs\_review} & 4 & V/C, OOD, uncertainty và thiếu citation \\
...
Trong case refinement, candidate đầu có \texttt{green\_time\_ratio=0.70} và
...
\rowcolor{rowgray}
Demo offline 13 capability & Pass khi manifest version 1.0 hợp lệ & Synthetic, aggregate-only \\
